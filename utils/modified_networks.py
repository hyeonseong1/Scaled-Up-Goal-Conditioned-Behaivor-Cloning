...
class MLP(nn.Module):
    ...
    def __call__(self, x):
        for i, size in enumerate(self.hidden_dims):
            ...
            # additional process where output layer
...
# TODO: modify GCValue to SimbaV2Critic ✅
class GCValue(nn.Module):
    ...
    def __call__(self,
                 ...
                 goals=None,                # goals: jnp.ndarray? not sure
...
# TODO: modify GCBilinearValue to SimbaV2Critic
...
# TODO: modify GCMRNValue to SimbaV2Critic
...
# TODO: modify GCIQEValue to SimbaV2Critic
